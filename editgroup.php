      ...
      ?>
		<form action="" method="POST">
		  ...
		  <div class="form-group hgad">
		    ...
		    <input type="number" class="form-control adgrfs" name="examRunningTime" placeholder="Minutes For Exam Running Time" required="1" value="<?php echo $value['examRunningTime'];?>">
		  </div>
		  <div class="form-group hgad">
		  ...
		  <button type="submit" class="btn btn-primary agb">Update Group</button>
		</form>
		<?php } }?>
	 </div>
    </div>
